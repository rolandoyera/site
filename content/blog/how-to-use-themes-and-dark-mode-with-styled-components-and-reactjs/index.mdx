...
Next, we will import React's state hook and define our `{theme}` variable. Also, we'll use the ternary operator to specify our theme conditions to the ThemeProvider. 
...
That was way too much to describe this: `${props => props.theme.bodyBg}`. I'll use this in place of any hardcoded property values that I have in the global styles file as so:
