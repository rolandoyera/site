...
tags:
  - Javascript
excerpt: The if statement executes a statement if a specified condition is truthy. If the condition is falsy, another statement can be executed.
banner: ./unsplash.jpg
---



![JavaScript If Else](./unsplash.jpg)
