...
![JavaScript Object](./unsplash.jpg)
...
> An object is an unordered set of name/value pairs. An object begins with `{` <sup>left</sup> brace and ends with `}` <sup>right</sup> brace. Each name is followed by `:` <sup>colon</sup> and the name/value pairs are separated by , comma.
