...
canonicalUrl: https://javascriptarticles.com/what-is-a-javascript-object
---
...
<p className="warn"> An object is an unordered set of name/value pairs. An object begins with a left brace and ends with right brace. Each name is followed by a colon and the name/value pairs are separated by , comma. </p>
